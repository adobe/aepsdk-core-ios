...
//! Project version number for AEPIdentity.
FOUNDATION_EXPORT double AEPIdentityVersionNumber;

//! Project version string for AEPIdentity.
...
#import <AEPIdentity/ACPIdentity.h>
