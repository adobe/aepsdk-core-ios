...
class EventHubTests: XCTestCase {
    ...
    func testEventHubDispatchesEventToListener() {
        ...
        // test
        eventHub.registerListener(parentExtension: MockExtension.self, type: testEvent.type, source: testEvent.source) { (event) in
    ...
    func testEventHubDoesNotInvokeListenerWrongType() {
        ...
        // test
        eventHub.registerListener(parentExtension: MockExtension.self, type: .acquisition, source: testEvent.source) { (event) in
            expectation.fulfill()
        }
    ...
    func testEventHubDispatchesEventsToCorrectListeners() {
        ...
        eventHub.registerListener(parentExtension: MockExtension.self, type: testEvent1.type, source: testEvent1.source) { (event) in
    ...
    func testEventHubDispatchesEventsWithBlockingListener() {
        ...
        // test
        eventHub.registerListener(parentExtension: MockExtensionTwo.self, type: testEvent.type, source: testEvent.source) { (event) in
            expectation.fulfill()
    ...
    func testEventHubDispatchesEventFromManyExtensionQueues() {
        ...
        // test
        eventHub.registerListener(parentExtension: MockExtension.self, type: type, source: source) { (event) in
