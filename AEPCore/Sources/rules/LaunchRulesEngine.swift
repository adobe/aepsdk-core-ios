        ...
        for rule in matchedRulesUnwrapped {
            for consequence in rule.consequences {
                ...
                case LaunchRulesEngine.CONSEQUENCE_TYPE_ADD:
                    ...
                    Log.trace(label: LOG_TAG, "Attaching event data with \(PrettyDictionary.prettify(from as [String : Any]))\n")
                ...
                case LaunchRulesEngine.CONSEQUENCE_TYPE_MOD:
                    ...
                    Log.trace(label: LOG_TAG, "Modifying event data with \(PrettyDictionary.prettify(from as [String : Any]))\n")
