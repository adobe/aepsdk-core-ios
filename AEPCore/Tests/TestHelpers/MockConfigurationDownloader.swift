...
class MockConfigurationDownloader: ConfigurationDownloadable {
    ...
    func loadConfigFrom(filePath _: String) -> [String: Any]? {
    ...
    func loadConfigFromCache(appId _: String, dataStore _: NamedCollectionDataStore) -> [String: Any]? {
        configFromCache
    }

    var configFromUrl: [String: Any]?
    func loadConfigFromUrl(appId _: String, dataStore _: NamedCollectionDataStore, completion: @escaping ([String: Any]?) -> Void) {
